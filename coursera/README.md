...
$\large \textit{Development / Holdout set}$
Because, the **goal** of the **dev set** or the **development set** is that **_you're going to test different algorithms on it_** and see which algorithm works better. 
...
> The rule of thumb: **_to make sure that the dev and test sets come from the same distribution_**.
